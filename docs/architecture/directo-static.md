...
En teléfonos horizontales, la cabecera global se elimina y sus acciones se trasladan a la cabecera del player principal. Al mostrar el chat también se oculta su cabecera externa redundante, de modo que el iframe oficial ocupa toda la altura de la columna derecha. Al intercambiar los players, la barra de acciones acompaña al nuevo principal; al volver a vertical se restaura automáticamente en la cabecera global sin remontar los reproductores.
