...
- En `/directo`, VK ocupa por defecto el área principal y Twitch permanece visible y silenciado mientras el chat móvil está plegado. El usuario puede intercambiar los players sin remontarlos. Al abrir el chat en móvil, este cubre siempre el segundo player: Twitch en el orden predeterminado o VK después de intercambiar.
...
- En mobile, al expandir el chat, el primer player permanece visible y el chat ocupa íntegramente el espacio inferior. Por eso cubre Twitch con el orden predeterminado y VK si los players fueron intercambiados; al plegarlo, el segundo player vuelve a quedar visible sin remontar su instancia.
