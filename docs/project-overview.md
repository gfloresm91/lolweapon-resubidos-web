...
| `/rastreador` | Tracker: lista de todos los directos con filtros. Las cards cómodas derivan una portada WebP desde la primera URL Piero y muestran una secuencia de cinco fotogramas al mantener hover en desktop; compacto, tabla, touch y movimiento reducido permanecen estáticos. Los recursos se sirven desde `/archive/drive/posters/` y la ausencia de un derivado degrada a placeholder. |
