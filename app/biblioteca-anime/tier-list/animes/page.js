...
export default async function AnimeTierListAnimesRoutePage() {
  ...
  return <HomePage activeView="animeTierListAnimes" isAdmin={isAdmin} currentUser={currentUser} accessPermissions={withPublicAccessPermissions(currentUser?.permissions)} />;
}
