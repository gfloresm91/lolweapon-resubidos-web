...
export default async function SeasonalAnimeCalendarRoutePage() {
  ...
  if (!can(currentUser, "anime.calendar.view")) {
  ...
  return <HomePage activeView="animeSeasonCalendar" initialAnimeCalendar={initialAnimeCalendar} isAdmin={isAdmin} currentUser={currentUser} accessPermissions={currentUser?.permissions || []} />;
}
