...
export const LOGIN_RULES = z
  ...
  .max(LOGIN_MAX_LENGTH, "El usuario no puede superar 32 caracteres.")
  .regex(LOGIN_PATTERN, "Usa solo letras, números, punto, guion o guion bajo.");
...
export function validatePasswordChangeFields(form) {
