...
const CONTENT_NOTIFICATIONS = [
  {
    ...
    body: "Inicio estrena el modo dual VK + Twitch y un teatro de Twitch con chat; los resubidos de Piero suman un reproductor con progreso, atajos, PiP y pantalla completa.",
    href: "/changelog",
    icon: "Sparkles",
    audience: "all",
