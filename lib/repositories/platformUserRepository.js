...
export const DEFAULT_PLATFORM_PERMISSIONS = [
  ...
  { code: "news.view", label: "Ver novedades", group: "Plataforma: Novedades", sortOrder: 2 },
  { code: "changelog.view", label: "Ver historial de cambios", group: "Plataforma: Historial de cambios", sortOrder: 3 },
...
export async function authenticateManualUser({ login, password }) {
  ...
  return compactUser(updatedUser);
}
