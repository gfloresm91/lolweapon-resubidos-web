...
export const DEFAULT_PLATFORM_PERMISSIONS = [
  ...
  { code: "news.view", label: "Ver novedades", group: "Novedades", sortOrder: 2 },
  { code: "changelog.view", label: "Ver historial de cambios", group: "Historial de cambios", sortOrder: 3 },
  ...
  { code: "tracker.calendar.view", label: "Ver calendario de directos", group: "Rastreador", sortOrder: 305 },
  ...
  { code: "spacedrum.view", label: "Ver SpaceDrum", group: "Lecturas", sortOrder: 400 },
  { code: "admin.spacedrum.chapters.view", label: "Ver capítulos", group: "Administración: SpaceDrum", sortOrder: 410 },
  { code: "admin.spacedrum.chapters.create", label: "Crear capítulos", group: "Administración: SpaceDrum", sortOrder: 420 },
  { code: "admin.spacedrum.chapters.update", label: "Editar capítulos", group: "Administración: SpaceDrum", sortOrder: 430 },
  { code: "admin.spacedrum.chapters.delete", label: "Eliminar capítulos", group: "Administración: SpaceDrum", sortOrder: 440 },
  { code: "admin.spacedrum.pages.view", label: "Ver páginas", group: "Administración: SpaceDrum", sortOrder: 450 },
  { code: "admin.spacedrum.pages.create", label: "Crear páginas", group: "Administración: SpaceDrum", sortOrder: 460 },
  { code: "admin.spacedrum.pages.update", label: "Editar páginas", group: "Administración: SpaceDrum", sortOrder: 470 },
  { code: "admin.spacedrum.pages.delete", label: "Eliminar páginas", group: "Administración: SpaceDrum", sortOrder: 480 },
  { code: "admin.spacedrum.settings.view", label: "Ver configuración", group: "Administración: SpaceDrum", sortOrder: 490 },
  { code: "admin.spacedrum.settings.update", label: "Editar configuración", group: "Administración: SpaceDrum", sortOrder: 500 },
  { code: "admin.spacedrum.import.view", label: "Ver importación", group: "Administración: SpaceDrum", sortOrder: 510 },
  { code: "admin.spacedrum.import.run", label: "Ejecutar importación", group: "Administración: SpaceDrum", sortOrder: 520 },
];
