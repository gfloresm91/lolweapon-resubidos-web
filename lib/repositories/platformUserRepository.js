...
export const DEFAULT_PLATFORM_PERMISSIONS = [
  ...
  { code: "news.view", label: "Ver novedades", group: "Plataforma: Novedades", sortOrder: 3 },
  { code: "changelog.view", label: "Ver historial de cambios", group: "Plataforma: Historial de cambios", sortOrder: 4 },
  ...
  { code: "admin.tracker.view", label: "Ver mantenedor Rastreador", group: "Administración: Rastreador", sortOrder: 470 },
  { code: "admin.lives.notify", label: "Notificar resubido", group: "Administración: Rastreador", sortOrder: 475 },
  { code: "admin.tags.view", label: "Ver mantenedor Tags", group: "Administración: Tags", sortOrder: 480 },
  { code: "tags.create", label: "Crear categorias de tags", group: "Administración: Tags", sortOrder: 490 },
  { code: "tags.update", label: "Editar tags", group: "Administración: Tags", sortOrder: 500 },
  { code: "tags.delete", label: "Eliminar tags", group: "Administración: Tags", sortOrder: 510 },
  { code: "admin.anime.tracking.view", label: "Ver mantenedor Viendo", group: "Administración: Anime Viendo", sortOrder: 520 },
  { code: "admin.anime.completed.view", label: "Ver mantenedor Terminados", group: "Administración: Anime Terminados", sortOrder: 530 },
  { code: "admin.spacedrum.chapters.view", label: "Ver capítulos", group: "Administración: SpaceDrum", sortOrder: 540 },
  { code: "admin.spacedrum.chapters.create", label: "Crear capítulos", group: "Administración: SpaceDrum", sortOrder: 550 },
  { code: "admin.spacedrum.chapters.update", label: "Editar capítulos", group: "Administración: SpaceDrum", sortOrder: 560 },
  { code: "admin.spacedrum.chapters.delete", label: "Eliminar capítulos", group: "Administración: SpaceDrum", sortOrder: 570 },
  { code: "admin.spacedrum.pages.view", label: "Ver páginas", group: "Administración: SpaceDrum", sortOrder: 580 },
  { code: "admin.spacedrum.pages.create", label: "Crear páginas", group: "Administración: SpaceDrum", sortOrder: 590 },
  { code: "admin.spacedrum.pages.update", label: "Editar páginas", group: "Administración: SpaceDrum", sortOrder: 600 },
  { code: "admin.spacedrum.pages.delete", label: "Eliminar páginas", group: "Administración: SpaceDrum", sortOrder: 610 },
  { code: "admin.spacedrum.settings.view", label: "Ver configuración", group: "Administración: SpaceDrum", sortOrder: 620 },
  { code: "admin.spacedrum.settings.update", label: "Editar configuración", group: "Administración: SpaceDrum", sortOrder: 630 },
  { code: "admin.spacedrum.import.view", label: "Ver importación", group: "Administración: SpaceDrum", sortOrder: 640 },
  { code: "admin.spacedrum.import.run", label: "Ejecutar importación", group: "Administración: SpaceDrum", sortOrder: 650 },
];
...
export async function ensurePlatformPermissions(prisma = getPrismaClient()) {
  ...
  for (const role of DEFAULT_PLATFORM_ROLES) {
    await assignDefaultPermissions(prisma, role.code, ["news.view", "changelog.view"]);
  }
  await assignDefaultPermissions(prisma, GUEST_ROLE_CODE, ["notifications.view"]);
...
export async function getPlatformUserBySessionToken(token) {
  ...
  if (shouldSyncTrackerCalendarPermission) {
    await ensurePlatformPermissions(prisma);
